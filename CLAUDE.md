...
| Version | **V6.38** — Build 20260625-arcleadsweepfix (2026-06-25, 10:00 MEZ) |
...
| **Build-Info** | `build-info.js` | **V6.38** | Versions-Banner, Modul-Versionen, Changelog |
...
├── js/
│   ├── build-info.js                  ← Versions-Banner V6.38
│   ├── constants.js                   ← Toleranzen, Farben, Defaults, Intarsia-Materialien (V2.10)
│   ├── app.js                         ← Hauptanwendung V6.38 (Lead-Profiles, Intarsien V2.0, Cycle-Selection)
