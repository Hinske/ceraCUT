...
| Version | **V6.40** — Build 20260625-cornerleadangle0 (2026-06-25, 10:45 MEZ) |
...
| **CAMContour** | `cam-contour.js` | **V5.16** | Lead-In/Out, Overcut, Multi-Contour-Collision, Lead-Routing (Corner-Penalty, Flat-Segment-Bonus, Dog-Leg), Slit, Kerf-Flip, Arc-Metadaten, clone(), leadManualOverride, Flat-Preferred autoPlace, Hatch-Entity (cuttingMode='none', isHatchContour), materialGroup, intarsiaRole |
...
| **Build-Info** | `build-info.js` | **V6.40** | Versions-Banner, Modul-Versionen, Changelog |
...
├── js/
│   ├── build-info.js                  ← Versions-Banner V6.40
│   ├── constants.js                   ← Toleranzen, Farben, Defaults, Intarsia-Materialien (V2.10)
│   ├── app.js                         ← Hauptanwendung V6.40 (Lead-Profiles, Intarsien V2.0, Cycle-Selection)
...
│   ├── cam-contour.js                 ← Kontur-Klasse V5.16 (Flat-Preferred autoPlace)
...
```
  ...
  cam-contour: V5.16 (20260625-cornerleadangle0)
