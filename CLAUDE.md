...
| **DXF Writer** | `dxf-writer.js` | **V1.13** | DXF R12 (AC1009) Export, ANSI_1252 Encoding, Kreis-Validierung |
...
| **Build-Info** | `build-info.js` | **V6.73** | Versions-Banner, Modul-Versionen, Changelog |
...
├── js/
│   ├── build-info.js                  ← Versions-Banner V6.73
│   ├── constants.js                   ← Toleranzen, Farben, Defaults, Intarsia-Materialien (V2.10)
│   ├── app.js                         ← Hauptanwendung V6.73 (Lead-Profiles, Intarsien V2.0, Cycle-Selection)
...
│   ├── dxf-writer.js                 ← DXF R12 Export V1.13 (UTF-8, Kreis-Validierung)
...
```
  ...
  dxf-writer: V1.13 (20260701-r12downgrade)
