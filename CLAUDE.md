...
| **Postprozessor** | `sinumerik-postprocessor.js` | **V2.1** | Sinumerik 840D MPF, 3-in-1, G41/G42, Piercing-Types, Multi-Head, Machine-Profile, Safety-Guards, Hatch-Filter |
...
| **Build-Info** | `build-info.js` | **V6.62** | Versions-Banner, Modul-Versionen, Changelog |
...
├── js/
│   ├── build-info.js                  ← Versions-Banner V6.62
│   ├── constants.js                   ← Toleranzen, Farben, Defaults, Intarsia-Materialien (V2.10)
│   ├── app.js                         ← Hauptanwendung V6.62 (Lead-Profiles, Intarsien V2.0, Cycle-Selection)
...
│   ├── sinumerik-postprocessor.js     ← Sinumerik PP V2.1 (Safety-Guards, Hatch-Filter)
...
```
  ...
  sinumerik-pp: V2.1 (20260626-kreisfix)
