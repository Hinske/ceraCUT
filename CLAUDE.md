...
## Module & Versionen (Stand 2026-06-30)
...
| **Build-Info** | `build-info.js` | **V6.71** | Versions-Banner, Modul-Versionen, Changelog |
...
├── js/
│   ├── build-info.js                  ← Versions-Banner V6.71
│   ├── constants.js                   ← Toleranzen, Farben, Defaults, Intarsia-Materialien (V2.10)
│   ├── app.js                         ← Hauptanwendung V6.71 (Lead-Profiles, Intarsien V2.0, Cycle-Selection)
