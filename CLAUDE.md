...
| Version | **V6.36** — Build 20260624-cornerleadfix (2026-06-24, 21:50 MEZ) |
...
| **CAMContour** | `cam-contour.js` | **V5.14** | Lead-In/Out, Overcut, Multi-Contour-Collision, Lead-Routing (Corner-Penalty, Flat-Segment-Bonus, Dog-Leg), Slit, Kerf-Flip, Arc-Metadaten, clone(), leadManualOverride, Flat-Preferred autoPlace, Hatch-Entity (cuttingMode='none', isHatchContour), materialGroup, intarsiaRole |
...
| **Build-Info** | `build-info.js` | **V6.36** | Versions-Banner, Modul-Versionen, Changelog |
...
├── js/
│   ├── build-info.js                  ← Versions-Banner V6.36
│   ├── constants.js                   ← Toleranzen, Farben, Defaults, Intarsia-Materialien (V2.10)
│   ├── app.js                         ← Hauptanwendung V6.36 (Lead-Profiles, Intarsien V2.0, Cycle-Selection)
...
│   ├── cam-contour.js                 ← Kontur-Klasse V5.14 (Flat-Preferred autoPlace)
...
```
  ...
  cam-contour: V5.14 (20260624-cornerleadfix)
