...
| **Postprozessor** | `sinumerik-postprocessor.js` | **V2.0** | Sinumerik 840D MPF, 3-in-1, G41/G42, Piercing-Types, Multi-Head, Machine-Profile, Safety-Guards, Hatch-Filter |
...
│   ├── sinumerik-postprocessor.js     ← Sinumerik PP V2.0 (Safety-Guards, Hatch-Filter)
