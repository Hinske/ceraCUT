...
| Version | **V6.39** — Build 20260625-arcdegradethreshold (2026-06-25, 10:30 MEZ) |
...
|-------|-------|---------|---------------|
| **App** | `app.js` | **V6.22** | Wizard, Kontextmenu, Export-Modal, Undo (Granular per Kontur), ToolManager, Click-Routing, Window-Selection, DynamicInput, Print, FSAPI-Save, ProjectManager, CAM-Kontextmenu, Lead-Profiles, Intarsien V2.0, Layer-Visibility→Pipeline, Validation Engine, Multi-Material Export, Hatch-Entity, Undo/Redo-Button-Click, Snap-Modi-Statusbar, Cycle-Selection |
...
| **CAMContour** | `cam-contour.js` | **V5.15** | Lead-In/Out, Overcut, Multi-Contour-Collision, Lead-Routing (Corner-Penalty, Flat-Segment-Bonus, Dog-Leg), Slit, Kerf-Flip, Arc-Metadaten, clone(), leadManualOverride, Flat-Preferred autoPlace, Hatch-Entity (cuttingMode='none', isHatchContour), materialGroup, intarsiaRole |
...
| **Build-Info** | `build-info.js` | **V6.39** | Versions-Banner, Modul-Versionen, Changelog |
...
├── js/
│   ├── build-info.js                  ← Versions-Banner V6.39
│   ├── constants.js                   ← Toleranzen, Farben, Defaults, Intarsia-Materialien (V2.10)
│   ├── app.js                         ← Hauptanwendung V6.39 (Lead-Profiles, Intarsien V2.0, Cycle-Selection)
...
│   ├── cam-contour.js                 ← Kontur-Klasse V5.15 (Flat-Preferred autoPlace)
...
```
  ...
  cam-contour: V5.15 (20260625-arcdegradethreshold)
  ...
  app: V6.22 (20260624-referencerefresh)
