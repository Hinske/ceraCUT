...
| Version | **V6.43** — Build 20260625-narrowchannelcap (2026-06-25, 12:10 MEZ) |
...
| **CAMContour** | `cam-contour.js` | **V5.18** | Lead-In/Out, Overcut, Multi-Contour-Collision, Lead-Routing (Corner-Penalty, Flat-Segment-Bonus, Dog-Leg), Slit, Kerf-Flip, Arc-Metadaten, clone(), leadManualOverride, Flat-Preferred autoPlace, Hatch-Entity (cuttingMode='none', isHatchContour), materialGroup, intarsiaRole |
...
| **Build-Info** | `build-info.js` | **V6.43** | Versions-Banner, Modul-Versionen, Changelog |
...
├── js/
│   ├── build-info.js                  ← Versions-Banner V6.43
│   ├── constants.js                   ← Toleranzen, Farben, Defaults, Intarsia-Materialien (V2.10)
│   ├── app.js                         ← Hauptanwendung V6.43 (Lead-Profiles, Intarsien V2.0, Cycle-Selection)
...
│   ├── cam-contour.js                 ← Kontur-Klasse V5.18 (Flat-Preferred autoPlace)
...
```
  ...
  cam-contour: V5.18 (20260625-narrowchannelcap)
